...
const getConfig = (): ENV => {
  return {
    ...
    LINEASCAN_API_KEY: process.env.BSCSCAN_API_KEY,
    BASESCAN_API_KEY: process.env.BSCSCAN_API_KEY,
    OPTIMIZM_API_KEY: process.env.BSCSCAN_API_KEY,
    POLYGONZKSCAN_API_KEY: process.env.BSCSCAN_API_KEY,
